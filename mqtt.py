...
### AWS IOT Connection from Config file
aws_iot_endpoint = cf.get('mqtt_broker') # <random>.iot.<region>.amazonaws.com
aws_iot_port = cf.get('mqtt_port')
ca = cf.get('ca_certs')
cert = cf.get('certfile')
private =  cf.get('keyfile')
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            mqttc.connect(aws_iot_endpoint, aws_iot_port)
